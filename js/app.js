...
const Strumly = (() => {
  ...
  const icons = {
    ...
    book: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"></path><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"></path></svg>',
    settings:
    ...
    navAuth.innerHTML = `
      <div class="account">
        ...
        <ul class="account-menu" id="accountMenu">
          ...
          <li><a href="index.html?mine=1#courses">${icons.book}My courses</a></li>
